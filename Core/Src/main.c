...
int main(void)
{
  ...
  MX_GPU2D_Init();
  MX_HASH_Init();
  MX_I2C1_Init(); // HERE THERE BE DRAGONS. PLENTY OF SHIPS HAVE CRASHED AT THIS LIGHTHOUSE. DO NOT UNCOMMENT THIS
  // MX_I2C2_Init(); // MUST BE UNCOMMENTED DUE TO PIN CONFLICTS
  // MX_I2C4_Init(); // MUST BE UNCOMMENTED DUE TO PIN CONFLICTS
  MX_ICACHE_Init();
  MX_LPTIM2_Init();
  MX_LTDC_Init();
  MX_OCTOSPI1_Init();
