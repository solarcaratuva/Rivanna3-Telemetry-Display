...
//     bool charge_relay = false; //missing
//     bool discharge_relay = false; //missing
//     bool left = false; //missing
//     bool lowpow = false; //missing
//     bool hazard = false; //missing
//     bool regenval = false; //missing
//     bool cruiseinc = false; //missing
//     bool cruiseval = false; //missing
//     bool cruisedec = false; //missing
//     bool mtr = false; //missing
//     bool bps = false; //missing
// #ifndef SIMULATOR
